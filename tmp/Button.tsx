...
const buttonVariants = cva(
  // Base classes
  "relative flex items-center justify-center px-8 py-4 rounded-lg button-text text-nowrap transition-all duration-200 ease-in-out border-2 border-solid focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-opacity-50",
  {
    variants: {
      type: {
        primary: "",
    ...
    compoundVariants: [
      {
        disabled: true,
        class: "bg-gray-200 text-gray-400 border-gray-200 cursor-not-allowed",
      },
    ],
    defaultVariants: {
      type: "primary",
